    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', fontFamily: "'Pretendard', -apple-system, sans-serif", color: '#e2e8f0', padding: '32px' }}>
      ...
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <p style={{ color: '#64748b', marginTop: '4px', fontSize: '14px' }}>캔버스 2 · 전체 {hospitals.length}개 병원</p>
        </div>
        <div style={{ display: 'flex', gap: '12px' }}>
          <button style={{ padding: '10px 20px', background: 'transparent', border: '1px solid #334155', borderRadius: '8px', color: '#94a3b8', cursor: 'pointer', fontSize: '14px' }}>캔버스 1</button>
