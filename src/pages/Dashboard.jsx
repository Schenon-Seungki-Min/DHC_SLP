...
const clients = [
  { id: 1, name: '서울수면클리닉', type: 'hospital', portfolio: 'sleepq', address: '서울시 강남구 테헤란로 123', staff: '김수면', otherStaff: ['이진료', '박상담'], phone: '010-1234-5678', email: 'seoul@sleep.kr', lastVisit: '2024-12-20', scheduledVisit: '2025-01-15', visitCount: 12, progress: 4, memo: 'NECA 등록 완료. 처방 안정적', neca: '2024-06-15', partners: [{name: 'A파트너', date: '2024-12-20'}, {name: 'B파트너', date: '2024-12-18'}] },
  { id: 2, name: '강남브레인의원', type: 'hospital', portfolio: 'sleepq', address: '서울시 강남구 역삼동 456', staff: '이두뇌', otherStaff: ['최신경'], phone: '010-2345-6789', email: 'brain@clinic.kr', lastVisit: '2024-12-18', scheduledVisit: null, visitCount: 8, progress: 3, memo: '관심 높음. 다음 방문 시 샘플 제공 예정', neca: '2024-07-20', partners: [{name: 'A파트너', date: '2024-12-18'}] },
  { id: 3, name: '분당숙면병원', type: 'hospital', portfolio: 'sleepq', address: '경기도 성남시 분당구 정자동 789', staff: '박숙면', otherStaff: [], phone: '010-3456-7890', email: 'bundang@sleep.kr', lastVisit: '2024-12-15', scheduledVisit: '2025-01-20', visitCount: 5, progress: 2, memo: 'NECA 신청 검토 중', neca: '2024-08-10', partners: [{name: 'C파트너', date: '2024-12-15'}, {name: 'A파트너', date: '2024-12-10'}] },
  { id: 4, name: '인천꿈의원', type: 'hospital', portfolio: 'sleepq', address: '인천시 연수구 송도동 321', staff: '정꿈나라', otherStaff: ['한밤잠', '오숙면'], phone: '010-4567-8901', email: 'dream@incheon.kr', lastVisit: '2024-12-22', scheduledVisit: '2025-01-10', visitCount: 15, progress: 5, memo: '계약 체결 완료', neca: null, partners: [{name: 'B파트너', date: '2024-12-22'}] },
  { id: 5, name: '건강약국', type: 'pharmacy', portfolio: 'coaching', team: 'south_east', address: '서울시 송파구 잠실동 100', staff: '박약사', otherStaff: [], phone: '010-5555-6666', email: 'health@pharm.kr', lastVisit: '2024-12-19', scheduledVisit: '2025-01-18', visitCount: 6, progress: 3, memo: 'GLP 비만 관리 서비스 관심', neca: null, partners: [{name: 'D파트너', date: '2024-12-19'}] },
];
        ...
        {filteredClients.map((c, i) => (
          <div key={c.id} style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr 1fr 1fr 0.8fr 0.8fr 1fr', padding: '20px 24px', borderBottom: i < filteredClients.length - 1 ? '1px solid #f3f4f6' : 'none', alignItems: 'center', transition: 'background 0.2s' }} onMouseEnter={e => e.currentTarget.style.background = '#f3f4f6'} onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <div style={{ background: `linear-gradient(135deg, ${c.progress >= 4 ? '#4ade80' : c.progress >= 3 ? '#fbbf24' : '#94a3b8'}, ${c.progress >= 4 ? '#22c55e' : c.progress >= 3 ? '#f59e0b' : '#64748b'})`, color: '#ffffff', padding: '4px 10px', borderRadius: '12px', fontSize: '12px', fontWeight: '700' }}>{c.progress}</div>
            </div>
            {/* 메모 */}
            <div style={{ color: '#6b7280', fontSize: '13px', cursor: 'pointer', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} onClick={() => setPopup({ type: 'memo', data: c })}>{c.memo}</div>
          </div>
        ))}
      </div>
      ...
      {popup.type === 'memo' && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
          <div style={{ background: '#ffffff', borderRadius: '16px', padding: '32px', width: '450px', border: '1px solid #f3f4f6', position: 'relative' }}>
            ...
            <p style={{ color: '#6b7280', margin: '0 0 24px', fontSize: '14px' }}>메모</p>
