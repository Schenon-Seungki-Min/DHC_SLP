...
const initialClients = [
  ...
  { id: 5, name: '건강약국', type: 'pharmacy', portfolio: 'coaching', team: 'south_east', address: '서울시 송파구 잠실동 100', city: '서울시', district: '송파구', dong: '잠실동', staff: '박약사', otherStaff: [], phone: '010-5555-6666', email: 'health@pharm.kr', lastVisit: '2024-12-19', scheduledVisit: '2025-01-18', grade: 'B', memo: 'GLP 비만 관리 서비스 관심', memoIsPublic: true, neca: null, products: ['GLP-OP', 'CGM'], partners: [{name: 'D파트너', date: '2024-12-19', products: ['GLP-OP'], memo: 'GLP 설명'}] },
];
        ...
        {filteredClients.map((c, i) => (
          <div key={c.id} style={{ display: 'grid', gridTemplateColumns: '1.8fr 1.5fr 0.8fr 1fr 1.2fr 0.6fr 1fr', padding: '20px 24px', borderBottom: i < filteredClients.length - 1 ? '1px solid #f3f4f6' : 'none', alignItems: 'center', transition: 'background 0.2s' }} onMouseEnter={e => e.currentTarget.style.background = '#f3f4f6'} onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '4px' }}>
              ...
              <span style={{ color: '#9ca3af', fontSize: '14px', cursor: 'help' }} title="A: 월 3회 이상&#10;B: 월 2회&#10;C: 월 1회&#10;D: 필요시">?</span>
            </div>
            {/* 방문예정일 + 최종방문 */}
